            ...
            <Col md="9">
                <Card className="p-4 py-5 d-md-down-none">
                  <CardBody>
                    ...
                    <Row>
                        <Col xs="12">
                        <Button onClick={() => this.props.mainStore.connect()} size="md" color="primary" className="px-3">{this.props.mainStore.connection_state}</Button>&nbsp;&nbsp;
                        <Button onClick={() => this.props.mainStore.reset()} size="md" color="danger" className="px-3">Reset</Button>
                      </Col>
                    </Row>
                  </CardBody>
                </Card>
